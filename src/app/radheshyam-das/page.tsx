...
export default function RadheshyamDasPage() {
        ...
        {isBcdb ? (
          <div className="bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-xl border border-slate-200 overflow-hidden relative">
            ...
            <div className="bg-slate-50/85 backdrop-blur-md px-6 py-4 border-b border-slate-100 flex items-center justify-between shrink-0">
              <div>
                <h1 className="text-sm font-black uppercase tracking-wider text-slate-800">Radheshyam Das</h1>
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    ...
                    const iframe = document.getElementById("rsd-iframe") as HTMLIFrameElement;
                    if (iframe) iframe.src = "/rsd";
                  }}
            ...
            {/* Iframe container with responsive layout */}
            <div className="w-full relative bg-slate-50 overflow-x-auto h-[70vh] md:h-[76vh]">
              {iframeLoading && (
          ...
          <div className="bg-white p-12 rounded-[2.5rem] shadow-xl border border-slate-200 text-center max-w-2xl mx-auto space-y-6 mt-20">
            ...
            <p className="text-slate-400 font-medium">
              This portal is only visible to verified Ashram members. If you believe this is an error, please contact the administrator.
            </p>
          </div>
        )}
      </main>
