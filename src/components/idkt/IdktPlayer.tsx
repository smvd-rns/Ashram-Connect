      ...
      <div className="bg-white/95 backdrop-blur-2xl border border-white shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] rounded-[2rem] sm:rounded-[2.5rem] p-3 sm:p-6 flex flex-col gap-2 sm:gap-3 relative">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
            <div className="w-9 h-9 sm:w-12 sm:h-12 bg-linear-to-br from-orange-100 to-amber-50 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 shadow-inner">
              <Music className="w-4 h-4 sm:w-6 sm:h-6 text-orange-600 animate-pulse" />
            </div>
            <div className="min-w-0 pr-2">
              <h4 className="text-[11px] sm:text-sm font-black text-slate-900 truncate tracking-tight leading-tight">{currentTrack.name}</h4>
              <p className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5 sm:mt-1">ISKCON Desire Tree</p>
            </div>
          </div>
