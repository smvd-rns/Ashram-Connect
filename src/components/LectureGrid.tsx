          ...
          <div className="flex flex-col flex-1 items-center justify-center px-4 sm:px-6 gap-3 sm:gap-6 min-h-0 w-full">
            ...
            <div className="w-full max-w-[100vw] sm:max-w-5xl xl:max-w-6xl px-2 sm:px-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <button
                  onClick={() => openExternal(`https://www.youtube.com/watch?v=${activeLecture.youtube_id}`)}
                  className="flex-1 sm:flex-none flex items-center justify-center gap-3 px-6 py-3 bg-[#FF0000] hover:bg-[#cc0000] text-white text-[10px] sm:text-xs font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg shadow-red-900/40 active:scale-95 cursor-pointer"
                >
